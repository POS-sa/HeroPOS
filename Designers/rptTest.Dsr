...
Private Sub DataReport_Initialize()
    ...
    MyConn.Open
    sSQL = "SELECT Top 100 percent User_No ,User_Name as [Login_Name],First_Name + ' ' +Last_Name as [User_Name]," & _
    " Case Gender" & _
    " WHEN 0 THEN 'Male'" & _
    " WHEN 1 THEN 'Female'" & _
    " END As Gender" & _
    ", case User_Type" & _
    " WHEN 0 THEN 'Manager'" & _
    " WHEN 1 THEN 'Night Manager'" & _
    " WHEN 2 THEN 'Reservations Cleck'" & _
    " WHEN 3 THEN 'Waiter'" & _
    " WHEN 4 THEN 'Barman'" & _
    " WHEN 5 THEN 'GRV Clerk'" & _
    " WHEN 6 THEN 'Buyer'" & _
    " WHEN 7 THEN 'Supervisor'" & _
    " WHEN 8 THEN 'Cashier'" & _
    " WHEN 9 THEN 'Owner'" & _
    " END AS Type" & _
    " From Users " & frmUsers.lblOrderFilter.Caption

    MyRecSet.Open sSQL, MyConn, adOpenStatic, adLockReadOnly

    Set rptUsers.DataSource = MyRecSet
    On Error Resume Next
    Set rptUsers.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    On Error GoTo 0
    rptUsers.Sections(1).Controls(3).Caption = Branch_Name
    rptUsers.Sections(1).Controls(4).Caption = Branch_Address
End Sub
