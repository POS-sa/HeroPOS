VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRecipe 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Product Recipe"
   ClientHeight    =   11010
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   15240
   Icon            =   "rptRecipe.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Description or Product"
      EndProperty
      ItemType4       =   5
      ...
      BeginProperty Item8 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Unit of Measure"
      EndProperty
      ItemType9       =   5
...
Private Sub DataReport_Initialize()
    ...
    MyConn.Open
    With frmProducts
        sSQL = "Select * from Rec_Temp order by Line_No"
    End With
    MyRecSet.Open sSQL, MyConn, adOpenStatic, adLockReadOnly

    Set rptRecipe.DataSource = MyRecSet
    
'    On Error Resume Next
'    For i = 1 To rptRecipe.Sections(5).Controls.Count
'        rptRecipe.Sections(5).Controls(i).Caption = Str(i)
'    Next i
'    On Error GoTo 0
'    Exit Sub

    rptRecipe.Sections(2).Controls(3).Caption = "Recipe for: " & frmProducts.txtDescription & " - " & frmProducts.txtProductCode
    
    On Error Resume Next
    Set rptRecipe.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    On Error GoTo 0
    rptRecipe.Sections(1).Controls(3).Caption = Branch_Name
    rptRecipe.Sections(1).Controls(4).Caption = Branch_Address
    rptRecipe.Sections(5).Controls(5).Caption = frmProducts.txtLandCost
    rptRecipe.Sections(5).Controls(6).Caption = frmProducts.txtGross & "%"
    rptRecipe.Sections(5).Controls(7).Caption = frmProducts.txtSellIncl
