VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptTransfers 
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item4 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Transfering Location"
      EndProperty
      ItemType5       =   5
      ...
      BeginProperty Item10 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Receiving Location"
      EndProperty
      ItemType11      =   5
...
Private Sub DataReport_Activate()
    ...
    If frmMain.cmdBar(5).Enabled = False Then
        sSQL = "Select * from Transfer_View where Transfer_No = " & frmReports.grdMain.TextMatrix(frmReports.grdMain.Row, 2) & " order by Line_No"
    Else
        sSQL = "Select * from Transfer_View where Transfer_No = " & Val(frmMain.Toolbar1.Tag) & " order by Line_No"
    End If
    MyRecSet.Open sSQL, MyConn, adOpenStatic, adLockReadOnly

    Set rptTransfers.DataSource = MyRecSet
    
'    On Error Resume Next
'    For i = 1 To rptTransfers.Sections(2).Controls.Count
'        rptTransfers.Sections(2).Controls(i).Caption = Str(i)
'    Next i
'    On Error GoTo 0
    On Error Resume Next
    Set rptTransfers.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    rptTransfers.Sections(1).Controls(3).Caption = Branch_Name
    rptTransfers.Sections(1).Controls(4).Caption = Branch_Address
    rptTransfers.Sections(1).Controls(9).Caption = Format(MyRecSet.Fields("Date_Time"), "ddd dd MMM yyyy")
    rptTransfers.Sections(2).Controls(13).Caption = "Transfer No: " & Format(MyRecSet.Fields("Transfer_No"), "000000")
    On Error GoTo 0
End Sub
