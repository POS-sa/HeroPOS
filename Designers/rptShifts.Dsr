VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptShifts 
   Caption         =   "User Shift List..."
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "USER SHIFT LIST"
         Alignment       =   2
      EndProperty
      ItemType3       =   3
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
...
Private Sub DataReport_Activate()
    ...
    sSQL = "Select * from Shift_Temp order by Line_No"
    MyRecSet.Open sSQL, MyConn, adOpenStatic, adLockReadOnly

    Set rptShifts.DataSource = MyRecSet
    On Error Resume Next
    Set rptShifts.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    On Error GoTo 0
    rptShifts.Sections(1).Controls(3).Caption = Branch_Name
    rptShifts.Sections(1).Controls(4).Caption = Branch_Address
    rptShifts.Sections(2).Controls(7).Caption = "Reporting from " & frmReports.lblDate.Caption
    On Error Resume Next
    Set rptShifts.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    On Error GoTo 0
End Sub
