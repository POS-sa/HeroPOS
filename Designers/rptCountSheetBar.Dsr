VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCountSheetBar 
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1575
         Object.Height          =   1875
         Picture         =   "rptCountSheetBar.dsx":0000
         SizeMode        =   1
      EndProperty
      ItemType1       =   6
   ...
   EndProperty
End
Attribute VB_Name = "rptCountSheetBar"
...
Private Sub DataReport_Initialize()
    ...
    Set rptCountSheetBar.DataSource = MyRecSet
    On Error Resume Next
    Set rptCountSheetBar.Sections(1).Controls(1).Picture = LoadPicture(Logo_File)
    On Error GoTo 0
    rptCountSheetBar.Sections(1).Controls(3).Caption = Branch_Name
    rptCountSheetBar.Sections(1).Controls(4).Caption = Branch_Address
