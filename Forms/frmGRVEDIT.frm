...
Begin VB.Form frmGRVEDIT 
   ...
   Begin VSFlex8Ctl.VSFlexGrid grdSupp 
      ...
      FormatString    =   $"frmGRVEDIT.frx":0000
      ScrollTrack     =   -1  'True
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid grdGRV 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   -1  'True
      FormatString    =   $"frmGRVEDIT.frx":0078
      ScrollTrack     =   -1  'True
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   5
...
Private Sub lblGRV_Click()
'open the grvno searchpanel
End Sub
