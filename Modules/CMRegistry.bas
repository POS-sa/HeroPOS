Attribute VB_Name = "CMRegistry"
Option Explicit
Public Emailsetup As Boolean
Public ComputerNames As String
Public shw As String
Public Pricelistpreview As String
...
' --------------------------------------------------------------
' Set PDF printer name an path
  Public Const Pdfprinter = "PDFill PDF Writer"
  Public Const Pdffolder = "\PDFReports"
  Public PDFAPPNAME As String
' --------------------------------------------------------------
...
Public Sub regCreate_Key_Value(ByVal lngRootKey As Long, ByVal strRegKeyPath As String, _
                               ByVal strRegSubKey As String, varRegData As Variant, Custom As Boolean)
...
Public Sub Setpdfprinter()
If Pdfprinter = "" Then Exit Sub
...
Public Sub Update(Ustring As String)
regCreate_Key_Value HKEY_CURRENT_USER, "Software\CUSTPDF Writer", "DefaultLocation", Ustring, False
End Sub




Public Function Emailattachment(Accnum As String, Accnames As String, Accemail As String)
MsgBox Accnum & Accnames & "   " & Accemail
Dim Emailattachmentname As String
Emailattachmentname = App.Path & "\PDFReports\" & Trim(Accnum) & Trim(Accnames) & ".pdf"
